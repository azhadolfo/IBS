...
namespace IBS.Migrations
{
    /// <inheritdoc />
    public partial class InitialmigrationofRealPos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Calibration = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorpCode = table.Column<int>(type: "integer", nullable: false),
                    SiteCode = table.Column<int>(type: "integer", nullable: false),
                    TTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Stamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Stamp2 = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CashierId = table.Column<string>(type: "varchar(10)", nullable: false),
                    CashierName = table.Column<string>(type: "varchar(20)", nullable: false),
